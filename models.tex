...
Seamless integration for  past and (forecasted) future values of time series is crucial for advanced application domains. For example, in energy domain, it is important to balance the production and consumption electricity. Typically, for these applications, it is  more useful to provide  immediate approximate answers for queries than  later exact answers. For future data points, we can only compute approximate answers.
The main idea behind in our proposed system, TimeTravel, is to compactly represent time series as models.
By using models, we can answer queries approximately on past and future data with error guarantees (absolute error and confidence) one order of magnitude faster than when accessing the time series directly. 
In addition, it efficiently supports exact historical queries by only accessing relevant portions of the time series.  This is unlike existing approaches, which access the entire time series to exactly answer the query.
...
\center
\subfigure{
\includegraphics[width=2.0in]{figs/example2_1.pdf}}
\subfigure{
\includegraphics[width=2.0in]{figs/example2_2.pdf}}
...
\center
\subfigure{
\includegraphics[width=1.5in]{figs/expr/g_scal_l1i1.pdf}}
\subfigure{
\includegraphics[width=1.5in]{figs/expr/g_scal_l1i2.pdf}}
\subfigure{
\includegraphics[width=1.5in]{figs/expr/g_scal_l1i10.pdf}}
\subfigure{
\includegraphics[width=1.5in]{figs/expr/g_scal_l0i100.pdf}}
...
\center
\subfigure{
\includegraphics[width=2.0in]{figs/expr/g_layers_i2.pdf}}
\subfigure{
\includegraphics[width=2.0in]{figs/expr/g_layers_i10.pdf}}
\subfigure{
\includegraphics[width=2.0in]{figs/expr/g_layers_i100.pdf}}
...
\center
\subfigure{
\includegraphics[width=2.0in]{figs/expr/g_interval_l0.pdf}}
\subfigure{
\includegraphics[width=2.0in]{figs/expr/g_interval_l1.pdf}}
\subfigure{
\includegraphics[width=2.0in]{figs/expr/g_interval_l2.pdf}}
...
\center
\subfigure{
\includegraphics[width=1.5in]{figs/expr/g_forecast_MA_l0.pdf}}
\subfigure{
\includegraphics[width=1.5in]{figs/expr/g_forecast_MA_l1.pdf}}
\subfigure{
\includegraphics[width=1.5in]{figs/expr/g_forecast_AA.pdf}}
\subfigure{
\includegraphics[width=1.5in]{figs/expr/g_forecast.pdf}}
