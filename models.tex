...
\includegraphics[width=5.5in]{figs/overview5.pdf}
...
To motivate our proposed problem, we start by introducing a small example based on the power consumption in UK grid real world time series.
...
\center
\subfigure{
\includegraphics[width=2.5in]{figs/example2_1.pdf}}
\subfigure{
\includegraphics[width=2.5in]{figs/example2_2.pdf}}
