...
Seamless integration for  past and (forecasted) future values of time series is crucial(critical) for advanced application domains. For example, consider balancing  production and consumption of electricity, in a smart-grid application.  In such scenario, it is  more useful to provide  immediate approximate answers for queries than  later exact answers. Also, For future data points, we can only compute approximate answers.
